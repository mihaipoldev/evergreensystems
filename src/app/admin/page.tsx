...
async function AnalyticsContent({ scope }: { scope: string }) {
  ...
  if (eventsError || !events || events.length === 0) {
    ...
    events.filter((e) => e.country !== null).forEach((e) => {
    ...
    events.filter((e) => e.event_type === "session_start" && e.country !== null).forEach((e) => {
    ...
    events.filter((e) => e.event_type === "page_view" && e.country !== null).forEach((e) => {
    ...
    events.filter((e) => e.event_type === "link_click" && e.entity_type === "cta_button" && e.country !== null).forEach((e) => {
    ...
    events.filter((e) => e.event_type === "link_click" && e.entity_type === "media" && e.country !== null).forEach((e) => {
...
export default async function AdminPage({ searchParams }: AnalyticsPageProps) {
