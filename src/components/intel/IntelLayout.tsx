          ...
          <div className="relative flex min-h-screen bg-background overflow-x-hidden">
            ...
            <div className="relative flex flex-1 flex-col md:pl-64 min-w-0">
              ...
              <main className="flex flex-1 flex-col min-w-0 px-4 md:px-6 lg:px-8 relative">
                ...
                <div className="mx-auto w-full max-w-[1400px] flex flex-col min-w-0 pt-[40px] md:pt-[81px] pb-12 md:pb-0 relative z-10">
                  <div className="relative flex flex-col py-4 pb-4 md:pb-8 space-y-4 md:space-y-6 min-w-0">
                    {children}
                  </div>
                </div>
              </main>
