...
export function AdminHeader() {
  ...
  return (
    <header className="backdrop-blur-xl ml-0 md:ml-64 fixed top-0 left-0 right-0 z-50 flex h-[56px] md:h-[81px] items-center gap-2 p-2 px-2 md:px-10 lg:px-12 border-b border-border/50">
