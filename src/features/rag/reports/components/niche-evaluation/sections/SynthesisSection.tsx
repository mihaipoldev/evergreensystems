    ...
    >
      ...
      >
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-accent/10 flex-shrink-0">
            <FontAwesomeIcon icon={faFileAlt} className="w-6 h-6 text-accent" />
          </div>
          <div>
