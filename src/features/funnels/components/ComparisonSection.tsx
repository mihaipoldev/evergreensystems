    ...
    <section className="section-spacing md:px-0 px-3">
      <div className="max-w-4xl mx-auto">
        ...
        >
          {/* Option 1 - DIY */}
          <motion.div 
            className="group relative overflow-hidden rounded-2xl p-8 hover:border-border transition-all"
            variants={{
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="heading-md mb-3">Build it yourself</h3>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="heading-md mb-3">Hire a typical lead generation agency</h3>
                <p className="body-md text-foreground/80">
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-2xl bg-primary/5 border-2 border-primary/20 p-8">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    <h3 className="heading-md">Run a fully managed, enriched outbound system</h3>
                  </div>
                  ...
                  <p className="body-md text-foreground/90 leading-relaxed">
